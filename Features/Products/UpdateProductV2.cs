...
public static class UpdateProductV2
{
    ...
    public class Handler
    {
        ...
        public async Task<Results<Ok<ProductDto>, NotFound<ErrorResponse>,BadRequest<ErrorResponse>>> Handle(RouteParameter routeParameter, Command command, CancellationToken ct)
        {
    ...
    public static void Map(IEndpointRouteBuilder routes)
    {
        ...
        .WithName("UpdateProduct V2")
        .WithSummary("Update an existing product V2.")
        .WithDescription("Updates a product by its unique ID, with cache invalidation V2.")
        .AddEndpointFilter(new FeatureFlagFilter("UpdateProductEnabled","v2"))
